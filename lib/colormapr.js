...
//  console.log('Colorscale, datadomain',datamin, datamax);
 ...
 // topnode.innerHTML =chart[0][0].innerHTML;
  ...
  if (typeof(topnode.attributeChangedCallback)=='function') {
    console.log('in function');
    topnode.attributeChangedCallback();
  }
...
var init_colormap=function init_colormap (i, topnode) {
  ...
  if (!('attributeChangedCallback' in topnode)) {
    topnode.attributeChangedCallback=null;
  }
