    ...
    Base64.base64DecodeLookup = function() {
      ...
      for( var i = 0; i < Base64.base64String.length; i ++ ) {
        base64DecodeLookupTable[ Base64.base64String[ i ].charCodeAt( 0 ) ] = i;
      }
    ...
    Base64.toArrayBuffer = function() {
    
      var base64DecodeLookup = Base64.base64DecodeLookup;
    ...
    Base64.toArrayOfFloats = function( base64 ) {
    
      var arrayBuffer = Base64.toArrayBuffer( base64 );
