...
class printert ():
    ...
    def print_png():
        print 'print_png, output:', self.outfile
        xpage = web.page()
    ...
    def do_print (outfile, printtype='p'):

        self.outfile=outfile
        if printtype=='pdf':
            print 'start_print_pdf'
            QObject.connect(web, SIGNAL("loadFinished(bool)"), self.print_pdf)

        if printtype=='png':
            print 'start_print_png'
            QObject.connect(web, SIGNAL("loadFinished(bool)"), self.print_png)
